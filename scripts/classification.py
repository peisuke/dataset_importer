...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Annotation Data Importer: Classification')
    ...
    dataset = api_client.create_dataset(organization_id, datasetname, 'classification', props)
